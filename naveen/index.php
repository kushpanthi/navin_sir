...
<body>
    ...
    <header id="hero" class="hero" style="background-image: url('<?php echo htmlspecialchars($content['background_image']); ?>')">
...
// Fetch the top 3 achievements
$achievements_sql = "SELECT * FROM achievements ORDER BY ordering ASC LIMIT 3";
$achievements_result = $conn->query($achievements_sql);
?>

<section class="achievements-container">
    <h2>Achievements</h2>
    <p>Celebrating milestones and recognitions in our journey of innovation and excellence.</p>
    ...
    <a href="achievements.php" class="view-all-btn">
